...
if (isset($iniVars['application_agent'])) {
  define('YAPEAL_APPLICATION_AGENT', $iniVars['application_agent']);
} else {
  $mess = 'config/yapeal.ini is outdated and application_agent is not set';
  trigger_error($mess, E_USER_NOTICE);
  define('YAPEAL_APPLICATION_AGENT', '');
};// if isset $iniVars['application_agent'] ...
/* **************************************************************************
 * Database section
 * **************************************************************************/
